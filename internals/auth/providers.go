...
type Provider struct {
	...
	ClientSecret string // Placeholder: replace with your registered app's client_secret
...
var providers = map[string]Provider{
	"github": {
		...
		ClientSecret: "699be979e15e26f12c35255d44c946a02a577b32",
		AuthHeader:   "token %s",
	},
	"gitlab": {
		Name:         "gitlab",
		...
		ClientSecret: "replace_with_your_gitlab_client_secret",
		AuthHeader:   "Bearer %s",
	},
	"bitbucket": {
		Name:         "bitbucket",
		...
		ClientSecret: "replace_with_your_bitbucket_client_secret",
		AuthHeader:   "Bearer %s",
	},
}
